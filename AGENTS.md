# Durable Goals: agent reference

This is the detailed protocol and CLI reference for agents working in this
repository. The shorter human-facing introduction lives in `README.md`.
...
`.agents/skills/`, so Codex can discover it from the repository root. For
broader installation across ChatGPT and Codex, the same skill can later be
bundled in a plugin; the protocol and Python package remain usable without that
plugin.
